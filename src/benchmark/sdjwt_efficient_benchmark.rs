...
use crate::delegation::entities::sdjwt::sdjwt_efficient_verifier::SdJWTEfficientVerifier;
use crate::delegation::entities::verifier::Verifier;
use josekit::jwk::Jwk;
use std::time::Duration;

pub struct SdJWTEfficientBenchmark {
    issuer_dlt: DLTSim<Jwk>,
    holder_dlt: DLTSim<Jwk>,
    delegator_ids: Vec<String>,
    credential_ids: Vec<String>,
    delegators: Vec<SdJWTEfficientIssuer>,
    context: Vec<String>,
    valid_from: String,
...
// TODO: Documentation
impl Benchmark for SdJWTEfficientBenchmark {
    fn new(delegators_size: usize) -> Result<SdJWTEfficientBenchmark, String> {
        ...
        let mut delegators: Vec<SdJWTEfficientIssuer> = vec![];
        ...
        for i in 0..delegators_size {
            ...
            let delegator = SdJWTEfficientIssuer::new(id, issuer_dlt.clone(), holder_dlt.clone())?;
    ...
    fn iterate_over_delegators(
        ...
        let verifier: SdJWTEfficientVerifier =
            SdJWTEfficientVerifier::new(self.issuer_dlt.clone(), self.holder_dlt.clone())?;
